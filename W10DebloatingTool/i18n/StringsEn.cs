...
namespace W10DebloatingTool.i18n
{
    public class StringsEn : IStrings
    {
        ...
        {
            get { return "Save Logs"; }
        }

        public string ChooseLogsPath
        {
            get { return "Please choose where to save the execution logs"; }
        }
        ...
        {
            get { return "This program is meant to be run on Windows 10."; }
        }
        ...
        public string RemoveOfficeHub
        {
            get
            {
                return "Remove Microsoft Office Hub";
            }
        }
        ...
        public string RemoveMail
        {
            get
            {
                return "Remove Mail and Calendar";
            }
        }
